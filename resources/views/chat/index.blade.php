    ...
    <div class="flex-1">
        ...
        <div class="h-screen overflow-y-auto p-4 pb-36">
           ...
           <div class="flex mb-4 cursor-pointer">
             ...
             <div class="flex max-w-96 bg-white rounded-lg p-3 gap-3" id="chat">
        ...
        <footer class="bg-white border-t border-gray-300 p-4 absolute bottom-0 w-3/4">
            <div class="flex items-center">
                <input type="text"  id="message" placeholder="Type a message..." class="w-full p-2 rounded-md border border-gray-400 focus:outline-none focus:border-blue-500">

                <input type="text"  id="nickname" placeholder="nickname..." class="w-full p-1 rounded-md border border-gray-400 focus:outline-none focus:border-blue-500">

                <button style="background-color:black" id="submitButton" class="bg-indigo-500 text-white px-4 py-2 rounded-md ml-2">Send</button>
            </div>
        </footer>
    </div>
</div>
